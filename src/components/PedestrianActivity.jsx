...
const PedestrianActivity = () => {
  return (
    <div className="flex flex-col bg-card w-full items-center justify-center p-4 rounded-xl border-2 border-card-outline text-secondary">
      ...
      <span className="border-[1px] mb-2 border-card-outline w-[80%]" />
